...
export const PROTOCOL_DEFS: ProtocolDef[] = [
  ...
  // ── Ample (yo-protocol on DefiLlama) ────────────────────────────────────────
  {
    id: 'ample-usdc',
    name: 'Ample',
    tagline: 'Highest USDC yields on Base',
    brand: '#7B4FE0',
    initials: 'AM',
    logo: '/logos/ample.png',
    detail: 'Ample offers some of the highest stablecoin yields on Base through its optimized yield strategy. $20M+ TVL in USDC with strong track record.',
    trust: 2,
    link: 'https://ample.money',
    steps: ['Open ample.money', 'Connect your wallet', 'Deposit USDC and start earning'],
    token: 'USDC',
    llamaProject: 'yo-protocol',
    llamaSymbol: 'USDC',
    llamaMinTvl: 500_000,
    llamaSortBy: 'apy',
    llamaExclude: [],
  },
  {
    id: 'ample-eth',
    name: 'Ample',
    tagline: 'High ETH yields on Base',
    brand: '#7B4FE0',
    initials: 'AM',
    logo: '/logos/ample.png',
    detail: 'Ample\'s ETH market delivers above-market yields through its optimized yield strategy. $12M+ TVL in WETH on Base.',
    trust: 2,
    link: 'https://ample.money',
    steps: ['Open ample.money', 'Connect your wallet', 'Deposit ETH and start earning'],
    token: 'ETH',
    llamaProject: 'yo-protocol',
    llamaSymbol: 'WETH',
    llamaMinTvl: 500_000,
